...
def test_inject_appends_pooling_aligner_stage():
    ...
    ext_pipeline, ext_deploy = _inject_forced_aligner_stage(
    ...
    assert aligner.execution_type == StageExecutionType.LLM_POOLING
...
def test_inject_noop_without_forced_aligner():
    ...
    ext_pipeline, ext_deploy = _inject_forced_aligner_stage(pipeline, deploy, {})
